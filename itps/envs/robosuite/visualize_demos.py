...
Usage:
    conda run -n diffpreff python -m itps.envs.robosuite.visualize_demos --demo-file data/robosuite/demos.hdf5
    conda run -n diffpreff python -m itps.envs.robosuite.visualize_demos --demo-file data/robosuite/demos.hdf5 --demo 3
    conda run -n diffpreff python -m itps.envs.robosuite.visualize_demos --demo-file data/robosuite/demos.hdf5 --all
"""
